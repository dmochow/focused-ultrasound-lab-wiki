## Resources for Operant Conditioning in Rats

1. A [paper](./nebraska_wild_norway.pdf) from the University of Nebraska that provides time estimates and optimal protocols for training wild rats
    - They provide ~14 days as mean number of sessions required
2. General rat handling [manual](https://krypton.mnsu.edu/~br8520zh/LMweb/LMf04.2) from Minnesota State University
